...
%    \vspace{1pt}
%
%    Bailey C., \textbf{Murphy M.}, Eremin A., Weissflog W., Jakli A. \\
%    \footnotesize\textit{Bundles of Fluid Fibers Formed by Bent-Core Molecules} \\
%    \footnotesize{\textit{Physics Review E} vol. 81, iss. 3, March 2010} \\
\end{tabularx}
